...
<script>
	...
	// make a variable to store the id of the div that will contain the vega-lite visualization
	const div = id();
	...
	// make specification for vega-lite
	...
	// record whether this component has been mounted
	let mounted = false;
	$: mounted;
	onMount(() => {
		mounted = true;
	...
	// put vega-lite visualization in div
	$: if (mounted) {
	...
	// define the function that checks whether the conditions are met
...
<!-- 
	1. make a variable to store the id of the div that will contain the vega-lite visualization
	2. define the size of the div
	3. make specification for vega-lite
	4. record whether this component has been mounted
	5. put vega-lite visualization in div
	6. compute overplotting
	7. define the function that checks whether the conditions are met
 -->